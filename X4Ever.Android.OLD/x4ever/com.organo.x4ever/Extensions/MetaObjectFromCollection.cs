    ...
    public static class MetaObjectFromCollection
    {
        ...
        public static async Task<UserMeta> Convert(this List<Meta> metas)
        {
            ...
            await Task.Run(() =>
            {
                ...
                var oGXProductPurchased = metas.FirstOrDefault(u => u.MetaKey.ToLower().Contains(MetaConstants.PRODUCT_PURCHASED));
                ...
                var weightToLose = metas.FirstOrDefault(u => u.MetaKey.ToLower().Contains(MetaConstants.WEIGHT_TO_LOSE));
                ...
                var weightLossGoal = metas.FirstOrDefault(u => u.MetaKey.ToLower().Contains(MetaConstants.WEIGHT_LOSS_GOAL));
                ...
                var whyJoiningChallenge = metas.FirstOrDefault(u => u.MetaKey.ToLower().Contains(MetaConstants.WHY_JOINING_CHALLENGE));
