...
using com.organo.x4ever.ViewModels.Milestones;
...
namespace com.organo.x4ever.Pages.MilestonePages
{
    public partial class UserMilestonePage : UserMilestonePageXaml
    {
        ...
        public UserMilestonePage(RootPage root, MyProfileViewModel profileViewModel)
        {
            try
            {
                ...
                {
                    if ((short) e.NewValue < _converter.DisplayWeightVolume(App.Configuration.AppConfig.MINIMUM_WEIGHT_LOSE))
