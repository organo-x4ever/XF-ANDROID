    ...
    public partial class ProfileSetting : ProfileSettingXaml
    {
        ...
        private async Task UpdateProfileAsync()
        {
            ...
            if (await Validate())
            {
                ...
                metaList.Add(await metaService.AddMeta(_model.CountryName, MetaConstants.COUNTRY, MetaConstants.COUNTRY,
                    MetaConstants.LABEL));
                metaList.Add(await metaService.AddMeta(_model.Address, MetaConstants.ADDRESS, MetaConstants.ADDRESS,
                    MetaConstants.LABEL));
                metaList.Add(await metaService.AddMeta(_model.CityName, MetaConstants.CITY, MetaConstants.CITY,
                    MetaConstants.LABEL));
                metaList.Add(await metaService.AddMeta(_model.StateName, MetaConstants.STATE, MetaConstants.STATE,
                    MetaConstants.LABEL));
                metaList.Add(await metaService.AddMeta(_model.PostalCode, MetaConstants.POSTAL_CODE,
                    MetaConstants.POSTAL_CODE, MetaConstants.LABEL));
                var response = await metaService.SaveMetaAsync(metaList);
                _model.SetActivityResource();
