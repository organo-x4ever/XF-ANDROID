    ...
    public static class ClientService
    {
        ...
        public static async Task<HttpResponseMessage> SendAsync(HttpMethod httpMethod, string controller, string method)
        {
            ...
            try
            {
                ...
                return await CheckHttpStatusCode(request.RequestUri, response);
            }
            catch (Exception exception)
            {
        ...
        public static async Task<HttpResponseMessage> PostDataAsync(object data, string controller, string method)
        {
            try
            {
                ...
                var response = await PostAsync(GetRequestUri(controller, method), byteContent);
                return await CheckHttpStatusCode(new Uri(GetRequestUri(controller, method)), response);
            }
            catch (Exception exception)
            {
                await WriteLog(new Uri(GetRequestUri(controller, method)), exception);
        ...
        public static async Task<HttpResponseMessage> GetDataAsync(string controller, string methodWithParams)
        {
            ...
            try
            {
                var response = await SendAsync(header);
                return await CheckHttpStatusCode(new Uri(GetRequestUri(controller, methodWithParams)), response);
            }
            catch (Exception exception)
            {
        ...
        public static async Task WriteLog(Uri requestUri, HttpRequestMessage requestMessage, Exception exception,
            bool showMessage = false)
        {
        ...
        public static async Task WriteLog(Uri requestUri, HttpRequestMessage requestMessage,
        ...
        public static async Task WriteLog(Uri requestUri, HttpContent httpContent, HttpResponseMessage responseMessage,
        ...
        public static void WriteDebugger(string message, string detail)
        {
