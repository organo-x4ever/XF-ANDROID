...
namespace com.organo.xchallenge.Extensions
{
    public static class ExceptionExtensions
    {
        ...
        /// </returns>
        /// <param name="ex">
        /// The <see cref="system.Exception" />.
        /// </param>
        /// <param name="callingClass">
        /// The class in which the exception was thrown. Usually you'll use the 'this' keyword for
        /// this parameter.
        /// </param>
        ...
        /// The <see cref="System.Type" /> of the calling class. Usually you'll pass
        /// 'typeof(CallingClass)' for this parameter.
        /// </param>
        ...
        /// <summary>
        /// Writes a formatted string to the debug output with the calling class name, exception
