using com.organo.xchallenge.Models.Local;
using System;
...
namespace com.organo.xchallenge.Extensions
{
    public static class ObservableCollectionExtensions
    {
        ...
        /// <summary> Adds a range of IEnumerable<T> to an ObservableCollection<Grouping<T,K>,
        /// grouped by a propertyName of type K. </summary> <param name="collection">An
        /// ObservableCollection<Grouping<T,K>>.</param> <param name="items">IEnumerable<T></param>
        /// <param name="propertyName">The property name on to group by. MUST be a valid property
        /// name (case-sensitive) on type T and MUST be of type K. Throws an ArgumentException if
        /// not.</param> /// <typeparam name="T">The type of items in the items collection of the
        /// Grouping.</typeparam> <typeparam name="K">The type of the Grouping key.</typeparam>
