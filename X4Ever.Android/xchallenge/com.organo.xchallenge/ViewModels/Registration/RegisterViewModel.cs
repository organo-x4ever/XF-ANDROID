...
namespace com.organo.xchallenge.ViewModels.Registration
{
    public class RegisterViewModel : Base.BaseViewModel
    {
        ...
        public const string SelectedContinentPropertyName = "SelectedContinent";

        public string SelectedContinent
        {
            get { return selectedContinent; }
            set { SetProperty(ref selectedContinent, value, SelectedContinentPropertyName); }
        }
